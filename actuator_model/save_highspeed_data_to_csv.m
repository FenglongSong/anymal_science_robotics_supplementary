...
%% Write LH_KFE joint position to csv
LH_KFE_joint_measure_pos = logElements(idx_pos(idx_)).data;
LH_KFE_joint_command_pos = logElements(idx_com(idx_)).data;
LH_KFE_joint_measure_vel = logElements(idx_vel(idx_)).data;
LH_KFE_joint_measure_tor = logElements(idx_tor(idx_)).data;

csvwrite('data_csv/highspeed_measure_pos.csv', LH_KFE_joint_measure_pos);
csvwrite('data_csv/highspeed_command_pos.csv', LH_KFE_joint_command_pos);
csvwrite('data_csv/highspeed_measure_vel.csv', LH_KFE_joint_measure_vel);
csvwrite('data_csv/highspeed_measure_tor.csv', LH_KFE_joint_measure_tor);
csvwrite('data_csv/highspeed_time.csv', time);
